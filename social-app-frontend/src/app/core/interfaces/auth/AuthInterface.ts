...
export interface AuthInterface {
     ...
     * registration request data. If the request is successful, the response data containing the user's authentication
     * and
    ...
    /**
     * Logs in a user by making a POST request to the authentication API's login endpoint with the
     * provided login request data.
     * If the request is successful, the response data containing the user's authentication and refresh tokens
     * will be added to
     * local storage.
     *
    ...
    /**
     * Sends a POST request to the authentication API's refresh endpoint with the provided refresh token
     * to obtain a new authentication
     * token. If the request is successful, the response data containing the new authentication and refresh
     * tokens will be added to
